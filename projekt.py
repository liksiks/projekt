...
btn_add = tk.Button(tab_main, text="Добавить фильм", command=add_movie)
...
entry_filter_genre = tk.Entry(tab_filter, width=30)
...
entry_filter_year = tk.Entry(tab_filter, width=30)
entry_filter_year.grid(row=1, column=1, padx=5, pady=5)

btn_filter = tk.Button(tab_filter, text="Применить фильтры", command=apply_filters)
